...
namespace PCAN_UDS_TEST
{
	public class SecurityAccess
	{
		...
		public byte[] GetKey(byte[] seed)
		{
			...
			//byte[] encryptedPassword = new byte[] { 0x5A, 0x86, 0xEF, 0xEC, 0x47, 0x18, 0xA5, 0x33, 0xFB, 0x88, 0x6B, 0x21, 0x0A, 0x2D, 0x6F, 0x89 };
			//byte[] encryptedPassword = new byte[] { 0x42, 0x98, 0x07, 0x75, 0x50, 0x89, 0x45, 0x98, 0xF0, 0x8C, 0x8C, 0x05, 0xC1, 0xF0, 0x22, 0xF1 };
			//byte[] encryptedPassword = new byte[] { 0x9F, 0xC8, 0x4F, 0x2C, 0x05, 0x6E, 0xE2, 0xD7, 0x4B, 0x9F, 0xEC, 0x89, 0x39, 0x13, 0xD5, 0x41 };
			//byte[] encryptedPassword = new byte[] { 0x01, 0x7A, 0x86, 0xB6, 0x3E, 0x6F, 0x28, 0xEF, 0x35, 0xEE, 0x2E, 0x0C, 0x5D, 0x7B, 0xA0, 0xFF };
			//byte[] encryptedPassword = new byte[] { 0x89, 0xC7, 0xD6, 0x9A, 0xE0, 0x5A, 0x53, 0x32, 0x7D, 0x0A, 0xB2, 0x2B, 0x44, 0x8F, 0x75, 0x41 };
			//byte[] encryptedPassword = new byte[] { 0x75, 0xAF, 0x4A, 0x83, 0xB5, 0x61, 0xDB, 0x9D, 0x80, 0xA9, 0x4B, 0x5D, 0xCA, 0xFF, 0xF9, 0x65 };
			byte[] encryptedPassword = new byte[] { 0x0B, 0xA6, 0xDC, 0x28, 0x45, 0xC8, 0x7B, 0xF9, 0xE8, 0x1B, 0xAC, 0x70, 0x53, 0x6A, 0x5F, 0xDA };
