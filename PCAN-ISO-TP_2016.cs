...
namespace Peak.Can.IsoTp
{
    ...
    /// </summary>
    public enum CantpHandle : UInt32
    {
        /// <summary>
    ...
    /// </summary>
    public enum CantpBaudrate : UInt32
    {
        /// <summary>
    ...
    /// </summary>
    public enum CANTP_CAN_MESSAGE_TYPE : UInt32
    {
        /// <summary>
    ...
    public struct cantp_can_info
    {
        ...
        /// </summary>
        [MarshalAs(UnmanagedType.U4)]
        public CANTP_CAN_MESSAGE_TYPE can_msgtype;
        /// <summary>
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 8)]
    public struct CantpMessageData
    {
        /// <summary>
    ...
    public struct cantp_msg
    {
        ...
        /// </summary>
        public CantpMessageData MessageDataAnyCopy
        {
            get
            {
                return (CantpMessageData)Marshal.PtrToStructure(msgdata, typeof(CantpMessageData));
            }
        }
    ...
    public static partial class CanTpApi
    {
        ...
        public static bool getFlags_2016(ref cantp_msg msg, out cantp_msgflag flags)
        {
            ...
            {
                flags = msg.MessageDataAnyCopy.flags;
                return true;
            }
        ...
        public static bool setLength_2016(ref cantp_msg msg, UInt32 len)
        {
            if (msg.Msgdata != IntPtr.Zero)
            {
                CantpMessageData msgdata = (CantpMessageData)Marshal.PtrToStructure(msg.Msgdata, typeof(CantpMessageData));
                msgdata.length = len;
        ...
        public static bool getLength_2016(ref cantp_msg msg, out UInt32 len)
        {
            if (msg.Msgdata != IntPtr.Zero)
            {
                len = msg.MessageDataAnyCopy.length;
                return true;
            }
            len = 0;
            return false;
        ...
        public static bool setData_2016(ref cantp_msg msg, Int32 i, byte val)
        {
            if (msg.Msgdata != IntPtr.Zero)
            {
                CantpMessageData msgdata = msg.MessageDataAnyCopy;
        ...
        /// </summary>
        /// <param name="message">Message structure to modify.</param>
        /// <param name="i">offset of the first byte in the message, cannot be more than 2147483647</param>
        /// <param name="size">number of bytes</param>
        /// <param name="byteArray">values to set, from offset 0</param>
        /// <returns>true if ok, false if not ok</returns>
        public static bool setData_2016(ref cantp_msg message, int i, byte[] byteArray, int size)
        {
            if (message.Msgdata != IntPtr.Zero)
            {
                CantpMessageData messageData = message.MessageDataAnyCopy;
                if (messageData.length > 0 && messageData.Data != IntPtr.Zero && i >= 0 && i + size - 1 < messageData.length && byteArray.Length >= size)
                {
                    if (i == 0) Marshal.Copy(byteArray, 0, messageData.Data, size);
                    else for (int j = 0; j < size; j++)
                            Marshal.WriteByte(messageData.Data, j + i, byteArray[j]);
                    return true;
                }
            }
            return false;
        ...
        public static bool getNetStatus_2016(ref cantp_msg msg, out cantp_netstatus status)
        {
            if (msg.Msgdata != IntPtr.Zero)
            {
                status = msg.MessageDataAnyCopy.netstatus;
                return true;
            }
