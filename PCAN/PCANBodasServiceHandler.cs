...
namespace PCAN_UDS_TEST.PCAN
{
    ...
    public struct Data
    {
        ...
        {
            if (dataIdentifier < 0xFD8E) return $"{name}: {minValue} - {value} - {maxValue}";
    ...
    public class PCANBodasServiceHandler
    {
        ...
        #region Constructor
        public PCANBodasServiceHandler(CantpHandle handle, byte sourceAddress, byte destinationAddress)
        {
            this.handle = handle;
            NAI = new()
            {
        ...
        public bool SetIO()
        {
            try
            {
                //FE09 - IN, 0x00 0x01 - DI, 0x00 0x02 - AI, 0x00 0x80 - FI
                SendRoutineControl(UDSApi.UDS_SERVICE_PARAMETER_ROUTINE_CONTROL.PUDS_SVC_PARAM_RC_STR, (UDSApi.UDS_SERVICE_PARAMETER_ROUTINE_CONTROL_IDENTIFIER)0xFE09, new byte[]
                {
                
                });
                //FE0A - OUT, 0x00 0x04 - PO_CUR, 0x02 0x00 - AOV_V, 0x00 0x40 - AOC_CUR
                SendRoutineControl(UDSApi.UDS_SERVICE_PARAMETER_ROUTINE_CONTROL.PUDS_SVC_PARAM_RC_STR, (UDSApi.UDS_SERVICE_PARAMETER_ROUTINE_CONTROL_IDENTIFIER)0xFE0A, new byte[]
                {
                0x01, 0x01, 0x00, 0x2F, 0x00, 0x04, 0x00, 0x04, 0x00, 0x04, 0x00, 0x04, 0x00, 0x04, 0x00, 0x04, 0x00, 0x04, 0x00, 0x04,
                0x00, 0x04, 0x00, 0x04, 0x00, 0x04, 0x00, 0x04, 0x00, 0x04, 0x00, 0x04, 0x00, 0x04, 0x00, 0x04, 0x00, 0x04, 0x00, 0x04,
                0x00, 0x04, 0x00, 0x04, 0x00, 0x04, 0x00, 0x04, 0x00, 0x04, 0x00, 0x04, 0x00, 0x04, 0x00, 0x04, 0x00, 0x04, 0x00, 0x04,
                0x00, 0x04, 0x00, 0x04, 0x00, 0x04, 0x00, 0x04, 0x02, 0x00, 0x02, 0x00, 0x02, 0x00, 0x02, 0x00, 0x00, 0x04, 0x00, 0x04,
                0x00, 0x04, 0x00, 0x04, 0x00, 0x04, 0x00, 0x04, 0x00, 0x04, 0x00, 0x04, 0x00, 0x04, 0x00, 0x04, 0x00, 0x40
                });
                return true;
            }
            catch (Exception)
        ...
        public byte[] SendDiagnosticSessionControl(UDSApi.UDS_SERVICE_DSC authParameter)
        {
